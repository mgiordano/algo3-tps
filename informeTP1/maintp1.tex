...
\lhead{Facultad de Ciencias Exactas y Naturales} 	% {Con esto se usa el header copado. También está \chead para
\rhead{Universidad de Buenos Aires} 	% el centro y comandos para el pie de página, buscar fancyhdr}
\renewcommand{\footrulewidth}{0.4pt}
\lfoot{\textit{Algoritmos y Estructuras de Datos III}}
%\rfoot{\textit{}}
